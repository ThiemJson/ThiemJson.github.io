            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $expData[0] ?></td>
                                <td><?php echo $expData[1] ?></td>
                                <td><?php echo $expData[2] ?></td>
                                <td><?php echo $expData[3] ?></td>
                                <td><?php echo $expData[4] ?></td>
                                <td><?php echo $expData[5] ?></td>
                                <td><?php echo $expData[6] ?></td>
                                <td><?php echo $expData[7] ?></td>
                                <td><?php echo $expData[8] ?></td>
                                <td><?php echo $expData[9] ?></td>
                                <td><?php echo $expData[10] ?></td>
                                <td>
            ...
            <div class="modal-content">
                <form action="../controllers/process-exp.php" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Job</label>
                            <input type="text" name="exp-job" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Possiton</label>
                            <input type="text" name="exp-possition" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Start date</label>
                            <input type="text" name="exp-start-date" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>End date</label>
                            <input type="text" name="exp-end-date" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Project</label>
                            <input type="text" name="exp-project" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <input type="text" name="exp-description" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Team size</label>
                            <input type="text" name="exp-team-size" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Responsiblities</label>
                            <input type="text" name="exp-respon" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Accomplishments</label>
                            <input type="text" name="exp-acc" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Technologies</label>
                            <input type="text" name="exp-tech" class="form-control" required="">
                        </div>
            ...
            <div class="modal-content">
                <form action="../controllers/process-exp.php" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input name="button-edit" type="submit" class="btn btn-info" value="Save">
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    $(document).ready(function() {
        $('a[href="#editEmployeeModal"]').click(function() {
            const id = this.parentElement.parentElement.children[0].innerHTML;
            $('#editEmployeeModal div div [name="exp-id"]').attr('value', this.parentElement.parentElement.children[0].innerHTML);
            $('#editEmployeeModal div div [name="exp-job"]').attr('value', this.parentElement.parentElement.children[1].innerHTML);
            $('#editEmployeeModal div div [name="exp-possition"]').attr('value', this.parentElement.parentElement.children[2].innerHTML);
            $('#editEmployeeModal div div [name="exp-start-date"]').attr('value', this.parentElement.parentElement.children[3].innerHTML);
            $('#editEmployeeModal div div [name="exp-end-date"]').attr('value', this.parentElement.parentElement.children[4].innerHTML);
            $('#editEmployeeModal div div [name="exp-project"]').attr('value', this.parentElement.parentElement.children[5].innerHTML);
            $('#editEmployeeModal div div [name="exp-description"]').attr('value', this.parentElement.parentElement.children[6].innerHTML);
            $('#editEmployeeModal div div [name="exp-team-size"]').attr('value', this.parentElement.parentElement.children[7].innerHTML);
