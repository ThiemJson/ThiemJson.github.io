				...
				<form action="process-about.php" method="post">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="text" name="about-image-link" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Summary</label>
							<input type="text" name="about-summary" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Location</label>
							<input type="text" name="about-location" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Phone</label>
							<input type="text" name="about-phone" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Email</label>
							<input type="text" name="about-email" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Link CV</label>
							<input type="text" name="about-link-cv" class="form-control" required="">
						</div>
					</div>
			...
			<div class="modal-content">
				<form action="../controllers/process-about.php" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Summary</label>
							<input type="text" name="about-summary" class="form-control" required="" value="">
						</div>
						<div class="form-group">
							<label>Location</label>
						...
						<div class="form-group">
							<label>Phone</label>
							<input type="text" name="about-phone" class="form-control" required="" value="<?php echo $aboutData[0][4] ?>">
						</div>
						<div class="form-group">
							<label>Email</label>
							<input type="text" name="about-email" class="form-control" required="" value="<?php echo $aboutData[0][5] ?>">
						</div>
						<div class="form-group">
							<label>Link CV</label>
							<input type="text" name="about-link-cv" class="form-control" required="" value="<?php echo $aboutData[0][6] ?>">
						</div>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" value="<?php echo $aboutData[0][7] ?>">
