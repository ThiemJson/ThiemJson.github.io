			...
			<div class="table-wrapper">
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						?>
							<tr>
								<td><?php echo $petData[0] ?></td>
								<td><?php echo $petData[1] ?></td>
								<td><?php echo $petData[2] ?></td>
								<td><?php echo $petData[3] ?></td>
								<td>
			...
			<div class="modal-content">
				<form action="../controllers/progess-pet.php" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Name</label>
							<input name="pet-name" type="text" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Description</label>
							<input name="pet-description" type="text" class="form-control" required="">
						</div>
						<div class="form-group">
							<label>Tecnologies</label>
							<input name="pet-tech" type="text" class="form-control" required="">
						</div>
...
<script>
	$(document).ready(function() {
		$('a[href="#editEmployeeModal"]').click(function() {
			...
			$('#editEmployeeModal div div [name="pet-id"]').attr('value', this.parentElement.parentElement.children[0].innerHTML);
